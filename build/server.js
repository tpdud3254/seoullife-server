...
var startServer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var app, httpServer, wsServer, serverCleanup, server, PORT;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return server.start();
          case 7:
            app.use("/graphql", (0, _cors["default"])(), _bodyParser["default"].json(), (0, _express2.expressMiddleware)(server));
            PORT = process.env.PORT;
            _context3.next = 11;
            return new Promise(function (r) {
              return httpServer.listen(PORT, r);
            });
          case 11:
