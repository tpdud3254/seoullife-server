...
var _default = {
  Mutation: {
    readMessage: function () {
      var _readMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_, _ref) {
        var userId, roomId, messages;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                userId = _ref.userId, roomId = _ref.roomId;
                _context2.next = 3;
