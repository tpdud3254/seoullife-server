...
var _default = {
  Room: {
    ...
    unreadTotal: function () {
      var _unreadTotal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref3) {
        var id, adminUser;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                return _context.abrupt("return", _client["default"].message.count({
                  where: {
                    read: false,
                    roomId: id,
                    user: {
