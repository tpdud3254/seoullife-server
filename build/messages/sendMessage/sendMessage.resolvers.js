...
var _default = {
  Mutation: {
    sendMessage: function () {
      var _sendMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(__, _ref) {
        var payload, roomId, userId, isAdmin, room, message, userEmail, adminUser, user, newRoom;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                payload = _ref.payload, roomId = _ref.roomId, userId = _ref.userId, isAdmin = _ref.isAdmin;
                room = null;
                message = null;
                userEmail = null;
                _context.next = 6;
