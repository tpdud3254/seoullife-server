...
var _default = {
  Subscription: {
    roomUpdates: {
      subscribe: function () {
        var _subscribe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(root, args, context, info) {
          var room;
                ...
                case 5:
                  return _context2.abrupt("return", (0, _graphqlSubscriptions.withFilter)(function () {
                    ...
                    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref, _ref2) {
                      var roomUpdates, roomId, userId, _room;
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              roomUpdates = _ref.roomUpdates;
                              roomId = _ref2.roomId, userId = _ref2.userId;
